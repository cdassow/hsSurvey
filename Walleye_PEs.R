...
names(VilasWal2)[names(VilasWal2) == "lake"] <- "waterbody"
...
#problems with ALLWALL
#mutliple county columns
#species AND species code column
#lake and waterbody columns, lake name 
#what to do about missing WBICs?
